    ...
    <div className="space-y-4">
      <div className="space-y-4">
        {fields.map((field, index) => (
          <div
            key={field.id}
            className="group relative flex gap-4 items-start bg-gray-50 p-4 rounded-lg border border-gray-200 transition-all"
          >
            <div className="flex-1">
              ...
              <Input
                ...
                placeholder="例: 山田 太郎"
                className={`bg-white ${errors.players?.[index]?.fullName ? "" : "border-gray-200"
                  }`}
              />

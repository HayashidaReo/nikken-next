                    ...
                    <div className="space-y-6">
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-600">メールアドレス</p>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div>
                                    <p className="text-sm font-medium text-gray-600">チーム名（所属名）</p>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-lg">選手一覧 ({data.players.length}名)</CardTitle>
                            </CardHeader>
                            <CardContent>

        ...
        <section id="features" className="py-32 bg-[#0a0a0a] relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    ...
                    {/* Keyboard Control (Spans 2 columns, but in 3-col grid it might need adjustment or just take remaining space) */}
                    {/* Actually, let's adjust layout: 
                        Row 1: Hybrid (2) + Dual Screen (1)
                        Row 2: Keyboard (3? or 2+1 blank? or just center?) 
                        Let's try:
                        Row 1: Hybrid (2) + Dual Screen (1)
                        Row 2: Keyboard (3)
                    */}
                    <motion.div
                        ...
                        className={`group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-8 hover:bg-white/10 transition-colors md:col-span-3`}
                    >
                        <div className="relative z-10 h-full flex flex-col md:flex-row items-center gap-8">
                            <div className="flex-1">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">キーボード操作</h3>
                                <p className="text-gray-400 leading-relaxed">素早いスコア入力のための最適化されたショートカット。</p>
                            </div>
                            <div className="flex-1 relative w-full h-64 rounded-xl overflow-hidden border border-white/5">
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] to-transparent z-10 opacity-50"></div>
                                <Image
                                    src="/about/monitor_controller.png"

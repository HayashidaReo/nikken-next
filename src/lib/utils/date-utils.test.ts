...
describe('date-utils', () => {
    describe('formatDateToInputValue', () => {
        ...
        it('様々なUTC時間のISO文字列を正しく変換する', () => {
            ...
            expect(formatDateToInputValue('2025-11-13T00:00:00.000Z')).toBe('2025-11-13');
            // UTC 14:59 → JST 23:59（同日）  
            expect(formatDateToInputValue('2025-11-13T14:59:00.000Z')).toBe('2025-11-13');
            // UTC 15:00 → JST 00:00（翌日）
            expect(formatDateToInputValue('2025-11-13T15:00:00.000Z')).toBe('2025-11-14');
            // UTC 23:59 → JST 08:59（翌日）
            expect(formatDateToInputValue('2025-11-13T23:59:00.000Z')).toBe('2025-11-14');
        });
    ...
    describe('isSameDate', () => {
        ...
        it('nullやundefinedの場合はfalseを返す', () => {
            ...
            expect(isSameDate(null as unknown as Date, null as unknown as Date)).toBe(false);
        });
    });
});
 ...
 * アカウント発行情報を含む
 */
export const organizationCreateWithAccountSchema = organizationSchema.omit({
    orgId: true,
    createdAt: true,
    updatedAt: true,
}).extend({
...
export type OrganizationCreateWithAccount = z.infer<typeof organizationCreateWithAccountSchema>;
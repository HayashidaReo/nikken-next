...
export function useActiveTournament() {
    ...
    useEffect(() => {
        try {
            ...
            console.error("Failed to load active tournament ID from localStorage:", error);
            addNotification({
                type: "error",
                title: "エラー",
    ...
    const setActiveTournament = useCallback((tournamentId: string | null) => {
        try {
            ...
            console.error("Failed to save active tournament ID to localStorage:", error);
            addNotification({
                type: "error",
                title: "エラー",
